...
public class sentiment {
 ...
 // set up optional output files
    String arg[]={"input.txt","output.txt"} ;
    PrintWriter out=new PrintWriter(arg[1]);
    
  
    PrintWriter xmlOut = null;
    if (arg.length > 2) {
      xmlOut = new PrintWriter(arg[2]);
    }
    ...
    if (arg.length > 0) {
      annotation = new Annotation(IOUtils.slurpFileNoExceptions(arg[0]));
    } else {
